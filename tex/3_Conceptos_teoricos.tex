...
\tablaSmall{Componentes de una Raspberry Pi 3 Model B}{l | c}{raspi3hardware}
{ \multicolumn{1}{l}{Componente} &Raspberry Pi 3B\\}{ 
CPU & BCM2837\\
Núcleos & 4\\
Velocidad & 1.2GHz\\
RAM & 1GB\\
...
\imagen{raspi}{Raspberry Pi 3.}

% ATENCIÓN!!!! CARNE DE ANEXO!
...
\item Se ha overclockeado el lector de microSD a 100MHz, en lugar de los 50MHz por defecto: \\Para ello se ha incluido en \code{/boot/config.txt} la línea \code{dtparam=sd\_overclock=100}.\\Y que arroja los siguientes resultados en un test:\imagen{sdbench}{Benchmark de lector microSD OC.}
\end{itemize} 



% HASTA AQUÍ ^ CARNE DE ANEXO!
